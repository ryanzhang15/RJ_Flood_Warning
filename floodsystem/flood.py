...
def stations_highest_rel_level(stations, N):
    """This function takes a list of MonitoringStation objects and an integer N, returning a list of the N stations with the highest relative water levels."""

    return [i[0] for i in stations_level_over_threshold(stations, -1.0)[:N]] # Return the first N stations with the highest relative water levels. Note -1 is set as the tolerance as all stations with data will have a relative water level > -1